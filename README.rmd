...
De las dos regresiones realizadas ( \ref{tab:reg2}) vemos una relación significativa entre el ingreso y el gasto, es decir, se pone en entre dicho la hipótisis de la caminata aleatoria. Además, podemos observar una relación más cercana entre ingreso y gasto para la población entre 30 y 40 años en hogares unipersonales. Los anterior es consistente con lo visto en clase, pues, esta población tiene más certidumbre sobre su futuro; probablemente estudios terminados o una situación laboral estable, por lo que un aumento en su ingreso es más probable que sea de carácter permanente y ante menor incertidumbre el ahorro precautorio es menor.
